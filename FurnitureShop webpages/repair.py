...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form">
        <br style="clear:both">
        <h2 class="font-style-home" style="margin-bottom: 25px; text-align: center;">Repair Form</h2>
...
if psubmit!=None:
    q = """insert into repair(name,phonenumber,productname,address) values('%s','%s','%s','%s')""" % (pname,pnumber,ppname, paddress)
    cur.execute(q)
    conn.commit()
