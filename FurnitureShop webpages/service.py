...
<html lang="en">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    </div><form class="form-height header-service">
<center>
  <h1 class="font-style-home">Welcome to UDC Furniture</h1><br>
  <p>Our company gives the door step service to our customers. Our service are deliver, repair and online order.</p>
</center>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <a href="deliver.py"><img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/d.png" height ="200px" alt="Deliver"></a>
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                       <a class="nav-link btn btn-sm btn-outline-secondary" href="deliver.py">Deliver</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <a href="repair.py"><img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/repair.jpg" height ="200px" alt="Repair"></a>
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                       <a class="nav-link btn btn-sm btn-outline-secondary" href="repair.py">Repair</a>
                    </div>
                  </div>
                </div>
              </div>
...
<center>
    <footer class="footer-bar bg-dark fixed-bottom">
     <div class="col-6 col-md ">
    <div class="footer-icon-side"></div>
    <div class="footer-icon"><center>
      <a href="www.facebook.com"><img src="img/facebook logo.jpg" alt="Facebook" width="30px" height="30px"></a>
    </center></div>
    <div class="footer-icon"><center>
      <a href="www.instragm.com"><img src="img/instagram logo.jpg" alt="Instagram" width="35px" height="30px"></a>
    </center></div>
    <div class="footer-icon-side"></div>
