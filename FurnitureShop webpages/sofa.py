          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/sofa.jpg" width="100%" height ="220px" alt="Leather sofa">
                <div class="overlay"><div class="text">
                   <p class="card-text">
                  Type      : Leather sofa<br>
                  Price     : $350<br>
                  Discount  : 20%
                  </p>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/Sofa1.jpg" width="100%" height ="220px" alt="Cotton sofa">
                <div class="overlay"><div class="text">
                  <p class="card-text">
                  Type      : Cotton sofa<br>
                  Price     : $300<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/sofa2.jpg" width="100%" height ="220px" alt="2-layers sofa">
                <div class="overlay"><div class="text">
                   <p class="card-text">
                  Type      : 2-layers sofa<br>
                  Price     : $200<br>
                  Discount  : 5%
                  </p>
                  </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/sofa4.jpg" width="100%" height ="220px" alt="Family sofa">
                <div class="overlay"><div class="text">
                  <p class="card-text">
                  Type      : Family sofa<br>
                  Price     : $400<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/twoseater sofa.jpg" width="100%" height ="220px" alt="Couple sofa">
                <div class="overlay"><div class="text">
                   <p class="card-text">
                  Type      : Couple sofa<br>
                  Price     : $200<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/sofa leather.jpg" width="100%" height ="220px" alt="Leather sofa">
                <div class="overlay"><div class="text">
                  <p class="card-text">
                  Type      : Leather sofa<br>
                  Price     : $550<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/modern sofa design.jpg" width="100%" height ="220px" alt="Modern sofa">
                <div class="overlay"><div class="text">
                   <p class="card-text">
                  Type      : Modern sofa<br>
                  Price     : %350<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/home chair.jpg" width="100%" height ="220px" alt="Leather sofa">
                <div class="overlay"><div class="text">
                  <p class="card-text">
                  Type      : Leather sofa<br>
                  Price     : $300<br>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" <img src="Images/sofa3.jpg" width="100%" height ="220px" alt="Cotton sofa">
                <div class="overlay"><div class="text">
                  <p class="card-text">
                  Type      : Cotton sofa<br>
                  Price     : $250<br>
