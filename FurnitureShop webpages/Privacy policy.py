...
<br><br>
 <hr class="featurette-divider">
        ...
        <div class="container">
          ...
          <p>&nbsp For the purpose of the Data Protection Act 1999 (the Act) and from 25th June 2018, the EU General Data Protection Regulations 2016/679 (the “GDPR”) the data controller is Unique Furniture Limited (company number 02307708) having its registered office at 258 Bath Road, Slough, Berkshire SL1 4DX.


We may change our Privacy Policy from time to time and if we do so we will update these changes on this page so that you’re up-to-date with our current policy.</p>

<p>&nbsp Unique Furniture Limited (“Unique Furniture”, “we” or “us”) are committed to protecting your privacy. Please read through this policy carefully so that you know how and why we collect information about you, how you can contact us to access, rectify, erase, restrict, port or object to your data being processed and what procedures we have in place to keep your personal data safe.
</p>

<h2>Social media platforms</h2>
<p>&nbsp Any communication, engagement and action on social media are subject to the terms and conditions and privacy policies held from each social media platform. In order to protect your own privacy and personal details, we advise that you use social media sites wisely. Other than to contact you regarding a specific query or complaint in which case we may request your name, order number and telephone number via Social Media. Otherwise, we will never ask for your private personal information via social media platforms. However, if you want to discuss your private personal details, we’re more than happy to help via telephone or email.</p>
<h2>Changes to our privacy policy</h2>
<p>&nbsp Any changes we may make to this Privacy Policy in the future will be posted on this page. Please check back frequently to see any updates or changes to this Privacy Policy.</p>
